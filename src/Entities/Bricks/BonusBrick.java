...
public class BonusBrick extends NormalBrick {
    ...
    public BonusBrick(int x, int y, Wall wall, Board table) {
        ...
        switch (bonusType) {
            case 0:
                this.bonusItem = new BonusLive(this.x, this.y, 20, 20, this.table, Assets.bonusBall);
                break;
            case 1:
                this.bonusItem = new ExtendTable(this.x, this.y, 20, 20,this.table, Assets.extendBonus);
                break;
        }
    }
