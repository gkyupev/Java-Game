...
public class Assets {
    ...
    public static BufferedImage bonusBall;
    public static BufferedImage extendBonus;
    ...
    public static void Init() {
        ...
        bonusBall =ImageLoader.loadImage("/BonusBall.png");
        extendBonus = ImageLoader.loadImage("/Extend.png");
